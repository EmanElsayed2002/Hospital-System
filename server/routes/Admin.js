...
const AdminDeleteProfile = require( "../controllers/Admin/Admin_DeleteProfile" );
...
router.post( "/edit", CheckAuth, adminCheck, AdminEditProfile.Edit );
router.post( "/getData", CheckAuth, adminCheck, AdminGetAdminDataByEmail.getAdminDataByEmail ); // Done for backend
router.post( "/deleteAdmin", CheckAuth, adminCheck, AdminDeleteProfile.deleteAdminProfile );
router.post( "/changepassword", CheckAuth, adminCheck, AdminChangePassword.changePassword ); // Done for backend
